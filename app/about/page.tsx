            ...
            <div className='space-y-6'>
              ...
              <div className='flex items-center gap-4 pt-4'>
                <div className='flex -space-x-2'>
                  <div className='w-10 h-10 bg-gradient-to-br from-emerald-500 to-green-500 rounded-full border-2 border-white dark:border-gray-800 overflow-hidden'>
                    <Image
                      src="/man1.jpeg"
                      alt='Founder'
                      width={40}
                  ...
                  <div className='w-10 h-10 bg-gradient-to-br from-green-500 to-teal-500 rounded-full border-2 border-white dark:border-gray-800 overflow-hidden'>
                    <Image
                      src= "/man2.jpeg"
                      alt='Founder'
                      width={40}
                  ...
                  <div className='w-10 h-10 bg-gradient-to-br from-teal-500 to-emerald-500 rounded-full border-2 border-white dark:border-gray-800 relative overflow-hidden'>
                    <Image
                      src="/man3.jpg"
                      alt='Founder'
                     fill
